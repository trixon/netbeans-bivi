 ...
 */
public abstract class AlbumNodeAction extends NodeAction {

    public Album getAlbum() {
        return getSelectedNode().getAlbum();
    }

    @Override
    public AlbumNode getSelectedNode() {
        return (AlbumNode) super.getSelectedNode();
    }
}
